  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      ...
      <p className="text-sm text-muted-foreground">
        A custom department for a process this business needs that isn&rsquo;t
        one of the built-in starters. It&rsquo;s created as a draft — add a
        classifier and handler workers on the next page, then activate it.
      </p>
      <WorkflowForm
